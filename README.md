...
This is a personal fork of Ivan Lednev's Show Diff plugin for Obsidian. It keeps
the original `show-diff` code-block syntax and adds side-by-side rendering,
files collapsed by default, accessible header toggles, and a compatibility fix
for inherited preformatted whitespace in table cells.

The original project and usage documentation follow below.
